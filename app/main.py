...
class CarWashStation:
    ...
    def calculate_washing_price(self, car_class: Car):
        difference = self.clean_power - car_class.clean_mark
        multiplier = car_class.comfort_class * difference * self.average_rating
