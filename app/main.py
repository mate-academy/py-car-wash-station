...
class CarWashStation:
    ...
    def calculate_washing_price(self, car: Car) -> float:
        ...
        price = diff * self.average_rating / self.distance_from_city_center
        return round(price * car.comfort_class, 1)
    ...
    def rate_service(self, mark: float) -> None:
        ...
        rating = mark + self.average_rating * (self.count_of_ratings - 1)
