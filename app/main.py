...
class CarWashStation:
    ...
    def calculate_washing_price(self, car):
        ...
        rate_for_km = self.average_rating / self.distance_from_city_center
        washing_price = car.comfort_class * diff * rate_for_km
    ...
    def rate_service(self, rate):
        ...
        self.average_rating = round((rates + rate) / self.count_of_ratings, 1)
