...
class CarWashStation:
    ...
    def calculate_washing_price(self, car: Car):
        clean_level = self.clean_power - car.clean_mark
        cost = (round((car.comfort_class * clean_level * self.average_rating /
    ...
    def rate_service(self, mark: int):
        ...
        self.average_rating = (
            round(((self.average_rating * (self.count_of_ratings - 1) + mark) /
                   self.count_of_ratings), 1))
