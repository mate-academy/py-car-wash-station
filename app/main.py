...
class CarWashStation:
    ...
    def serve_cars(self, cars: list):
        ...
        for car in cars:
            if car.clean_mark < self.clean_power:
                income_counter += car.comfort_class * (self.clean_power - car.clean_mark) * (
    ...
    def calculate_washing_price(self, car):
        return round(
            car.comfort_class * (self.clean_power - car.clean_mark) * (self.average_rating / self.distance_from_city),
            1)
