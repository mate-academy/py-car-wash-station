...
class CarWashStation:
    ...
    def calculate_washing_price(self, car: Car) -> float:
        initial_clean_power = self.clean_power
        return round(car.comfort_class * (initial_clean_power - car.clean_mark) * self.average_rating / self.distance_from_city_center, 1)
