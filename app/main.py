...
class CarWashStation:
    ...
    def calculate_washing_price(self, cars: Car) -> float:
        difference = (self.clean_power - cars.clean_mark)
        price = cars.comfort_class * difference * self.average_rating
    ...
    def rate_service(self, mark: int) -> None:
        all_marks = self.count_of_ratings * self.average_rating + mark
