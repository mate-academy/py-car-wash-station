...
class CarWashStation:
    ...
    def calculate_washing_price(self, car: Car) -> float:
        ...
        clean_hardness = self.clean_power - car.clean_mark
        quality = self.average_rating / self.distance_from_city_center
        one_wash_income = comfort * clean_hardness * quality
        return round(one_wash_income, 1)
