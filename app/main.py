...
class CarWashStation:
    ...
    def calculate_washing_price(self, car: Car) -> float:
        cleaning_value = car.comfort_class * (self.clean_power - car.clean_mark)
        station_value = self.average_rating / self.distance_from_city_center
        price = cleaning_value * station_value
