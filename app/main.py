...
class CarWashStation:
    ...
    def calculate_washing_price(self, single_car):
        rat_to_dist = self.average_rating / self.distance_from_city_center
        pow_to_mark = self.clean_power - single_car.clean_mark
        return round(single_car.comfort_class * pow_to_mark * rat_to_dist, 2)
